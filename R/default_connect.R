...
#'
#' @param scoring_type One of c("ppr", "half_ppr", "zero_ppr", "te_prem", "sfb11")
...
ff_default <- function(scoring_type = c("ppr","half_ppr","zero_ppr","sfb11"),
