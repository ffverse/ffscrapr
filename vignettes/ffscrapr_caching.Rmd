---
title: "Managing ffscrapr's Cache"
author: "Tan Ho"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ffscrapr_caching}
...
-   `mfl_players()`, `mfl_allrules()`, `sleeper_players()` - these functions are stored for 7 days
...
You can find an updated list of cached functions in the [zzz.R](https://github.com/dynastyprocess/ffscrapr/blob/main/R/zzz.R) source code page.
...
The simplest way to clear the cache if it is stored in memory is just to restart your R session. 

If your cache is stored on the hard disk, you can visit the directory given by the code above and delete everything in it. 

In a future version, ffscrapr will have some built in functions to empty its cache!
