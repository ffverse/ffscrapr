...
vignette: >
  %\VignetteIndexEntry{fleaflicker_basics}
...
library(httptest)
httptest::start_vignette("fleaflicker_basics")
```
...
In Fleaflicker, you can find the league ID by looking in the URL - it's the number immediately after /league/ in this example URL: https://www.fleaflicker.com/nfl/leagues/206154. 
...
# Drilling values down to just 1QB values, ages, IDs, we'll be joining it onto rosters and don't need the extra stuff
