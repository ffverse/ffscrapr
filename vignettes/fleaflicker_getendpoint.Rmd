...
vignette: >
  %\VignetteIndexEntry{fleaflicker_getendpoint}
...
library(httptest)
httptest::start_vignette("fleaflicker_getendpoint")
```
...
onegame_lineups <- fleaflicker_getendpoint(
  ...
  sport = sport, 
  league_id = league_id, 
  fantasy_game_id = df_scoreboard$id[[1]], # example for one call, but you can call this in a map or loop! 
  scoring_period = week) %>% 
