...
The [Sleeper API is pretty extensive](https://docs.sleeper.app), and I haven't written out a function for every single combination of the endpoints. If there is something you'd like to access, you can use the lower-level "`sleeper_getendpoint`" function to create a GET request and access the data, while still using the authentication and rate-limiting features I've already created. 
