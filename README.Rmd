...
*An R Client for Fantasy Football League APIs*
  ...
  [![R build status](https://img.shields.io/github/workflow/status/dynastyprocess/ffscrapr/R-CMD-check?label=R%20check&style=flat-square)](https://github.com/DynastyProcess/ffscrapr/actions)
