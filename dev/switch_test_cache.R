...
use_ffscrapr_tests_main <- function(){
  ...
  gsub_dir("archive/[0-9,\\.]+\\.zip", "archive/main.zip", dir = "tests",recursive = TRUE, ext = c("R","Rmd"))
  gsub_dir("archive/[0-9,\\.]+\\.zip", "archive/main.zip", dir = "vignettes",recursive = TRUE, ext = c("R","Rmd"))

  gsub_dir("ffscrapr\\-tests\\-[0-9\\.]+", "ffscrapr-tests-main", dir = "tests", recursive = TRUE, ext = c("R","Rmd"))
  gsub_dir("ffscrapr\\-tests\\-[0-9\\.]+", "ffscrapr-tests-main", dir = "vignettes", recursive = TRUE, ext = c("R","Rmd"))
...
# use_ffscrapr_tests_version('1.4.2')
