structure(list(url = "https://www54.myfantasyleague.com/2019/export?TYPE=schedule&L=12608&JSON=1", 
    status_code = 200L, headers = structure(list(date = "Mon, 03 Aug 2020 03:45:44 GMT", 
        server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        vary = "Accept-Encoding", `content-encoding` = "gzip", 
        `content-length` = "133", `content-type` = "application/json; charset=utf-8"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 302L, version = "HTTP/1.1", 
        headers = structure(list(date = "Mon, 03 Aug 2020 03:45:44 GMT", 
            server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
    ...
    date = structure(1596426344, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.138619, namelookup = 0.00017, 
    connect = 0.040104, pretransfer = 0.111512, starttransfer = 0.422242, 
    total = 0.422407)), class = "response")
