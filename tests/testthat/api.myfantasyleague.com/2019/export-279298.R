structure(list(url = "https://www57.myfantasyleague.com/2019/export?TYPE=rules&L=37920&JSON=1", 
    status_code = 200L, headers = structure(list(date = "Sat, 14 Nov 2020 17:39:18 GMT", 
        server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        vary = "Accept-Encoding", `content-encoding` = "gzip", 
        `content-length` = "273", `content-type` = "application/json; charset=utf-8"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 302L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sat, 14 Nov 2020 17:39:18 GMT", 
            server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
    ...
    date = structure(1605375558, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.277001, namelookup = 0.048621, 
    connect = 0.114359, pretransfer = 0.271616, starttransfer = 0.605841, 
    total = 0.605992)), class = "response")
