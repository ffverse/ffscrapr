structure(list(
  url = "https://www57.myfantasyleague.com/2020/export?TYPE=league&L=37920&JSON=1",
  status_code = 200L, headers = structure(list(
    date = "Mon, 27 Jul 2020 11:34:19 GMT",
    server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1",
    vary = "Accept-Encoding", `content-encoding` = "gzip",
    `content-length` = "1412", `content-type` = "application/json; charset=utf-8"
  ), class = c(
    "insensitive",
    "list"
  ...
  date = structure(1595849659, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0.243215, namelookup = 0.000566,
