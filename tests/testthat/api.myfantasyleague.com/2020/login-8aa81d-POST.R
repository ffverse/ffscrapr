structure(list(url = "https://api.myfantasyleague.com/2020/login",
  status_code = 200L, headers = structure(list(date = "Sun, 02 Aug 2020 22:23:47 GMT",
    ...
    headers = structure(list(date = "Sun, 02 Aug 2020 22:23:47 GMT",
      server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1",
      vary = "Accept-Encoding", `content-encoding` = "gzip",
      `content-length` = "127", `content-type` = "text/html; charset=utf-8",
      `set-cookie` = "REDACTED", `set-cookie` = "REDACTED",
    ...
    1598999027), class = c("POSIXct", "POSIXt")), name = c("MFL_USER_ID",
  ...
  date = structure(1596407027, class = c("POSIXct", "POSIXt"
  ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.000104,
    connect = 0.000108, pretransfer = 0.000287, starttransfer = 0,
    total = 0.145784)), class = "response")
