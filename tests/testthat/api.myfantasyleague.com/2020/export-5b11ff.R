structure(list(
  ...
  status_code = 200L, headers = structure(list(
    ...
    `content-length` = "1129", `content-type` = "application/json; charset=utf-8"
  ), class = c(
    "insensitive",
    "list"
