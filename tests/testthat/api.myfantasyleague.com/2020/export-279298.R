structure(list(url = "https://www57.myfantasyleague.com/2020/export?TYPE=rules&L=37920&JSON=1",
  status_code = 200L, headers = structure(list(date = "Sun, 14 Jun 2020 01:17:35 GMT",
    server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1",
    vary = "Accept-Encoding", `content-encoding` = "gzip",
    `content-length` = "261", `content-type` = "application/json; charset=utf-8"), class = c("insensitive",
    "list")), all_headers = list(list(status = 302L, version = "HTTP/1.1",
    headers = structure(list(date = "Sun, 14 Jun 2020 01:17:35 GMT",
      server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1",
  ...
  date = structure(1592097455, class = c("POSIXct", "POSIXt"
  ), tzone = "GMT"), times = c(redirect = 0.14591, namelookup = 0.000235,
    connect = 0.000242, pretransfer = 0.000603, starttransfer = 0.307067,
    total = 0.30719)), class = "response")
