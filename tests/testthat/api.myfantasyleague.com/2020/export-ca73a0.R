structure(list(url = "https://www61.myfantasyleague.com/2020/export?TYPE=rules&L=54040&JSON=1", 
    status_code = 200L, headers = structure(list(date = "Sun, 21 Jun 2020 17:22:48 GMT", 
        server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
        vary = "Accept-Encoding", `content-encoding` = "gzip", 
        `content-length` = "267", `content-type` = "application/json; charset=utf-8"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 302L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sun, 21 Jun 2020 17:22:48 GMT", 
            server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1", 
    ...
    date = structure(1592760168, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.140649, namelookup = 0.000148, 
    connect = 0.000153, pretransfer = 0.000376, starttransfer = 0.309165, 
    total = 0.309294)), class = "response")
