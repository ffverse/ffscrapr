structure(list(
  url = "https://www61.myfantasyleague.com/2019/export?TYPE=league&L=54040&JSON=1",
  status_code = 200L, headers = structure(list(
    date = "Mon, 27 Jul 2020 11:34:09 GMT",
    server = "Apache/2.4.18 (Unix) mod_apreq2-20090110/2.8.0 mod_perl/2.0.9 Perl/v5.10.1",
    vary = "Accept-Encoding", `content-encoding` = "gzip",
    `content-length` = "1180", `content-type` = "application/json; charset=utf-8"
  ), class = c(
    "insensitive",
    "list"
  ...
  date = structure(1595849649, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0.240845, namelookup = 0.000443,
