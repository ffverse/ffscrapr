structure(list(url = "https://api.sleeper.app/v1/user/solarpool", 
    status_code = 200L, headers = structure(list(date = "Thu, 13 Aug 2020 13:30:55 GMT", 
        `content-type` = "application/json; charset=utf-8", vary = "Accept-Encoding", 
        `cache-control` = "max-age=0, private, must-revalidate", 
        `x-request-id` = "88d36dbd9d6012d3c5d5dd95fb0f5b57", 
        ...
        `cf-request-id` = "04899d481e0000ca4b7dbe7200000001", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        server = "cloudflare", `cf-ray` = "5c22cb2039d0ca4b-YUL"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 13 Aug 2020 13:30:55 GMT", 
        ...
        flag = TRUE, path = "/", secure = TRUE, expiration = structure(1599917339, class = c("POSIXct", 
    ...
    date = structure(1597325455, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 4e-05, 
    connect = 4.4e-05, pretransfer = 0.000154, starttransfer = 0.13004, 
    total = 0.130113)), class = "response")
