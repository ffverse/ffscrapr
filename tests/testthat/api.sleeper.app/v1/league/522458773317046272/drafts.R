structure(list(url = "https://api.sleeper.app/v1/league/522458773317046272/drafts/", 
    status_code = 200L, headers = structure(list(date = "Tue, 13 Oct 2020 01:45:13 GMT", 
        `content-type` = "application/json; charset=utf-8", vary = "Accept-Encoding", 
        `cache-control` = "max-age=0, private, must-revalidate", 
        `x-request-id` = "75f3d73e87e3e92393abfd909eb66530", 
        ...
        `cf-request-id` = "05c13b1e560000ca6f41a9e200000001", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        server = "cloudflare", `cf-ray` = "5e156143bbe4ca6f-YUL"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(date = "Tue, 13 Oct 2020 01:45:13 GMT", 
