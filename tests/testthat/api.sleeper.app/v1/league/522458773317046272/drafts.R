structure(list(url = "https://api.sleeper.app/v1/league/522458773317046272/drafts/", 
    status_code = 200L, headers = structure(list(date = "Sat, 14 Nov 2020 16:45:56 GMT", 
        ...
        server = "cloudflare", `cf-ray` = "5f2234aacb54ecf6-YUL"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(date = "Sat, 14 Nov 2020 16:45:56 GMT", 
        ...
        flag = TRUE, path = "/", secure = TRUE, expiration = structure(1607964221, class = c("POSIXct", 
