structure(list(url = "https://api.sleeper.app/v1/league/527362181635997696/", 
    status_code = 404L, headers = structure(list(date = "Thu, 08 Oct 2020 12:18:43 GMT", 
        ...
        vary = "Accept-Encoding", server = "cloudflare", `cf-ray` = "5defce5add72ecaf-DFW"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 404L, version = "HTTP/1.1", 
        headers = structure(list(date = "Thu, 08 Oct 2020 12:18:43 GMT", 
