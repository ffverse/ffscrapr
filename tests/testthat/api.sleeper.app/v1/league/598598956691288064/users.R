structure(list(url = "https://api.sleeper.app/v1/league/598598956691288064/users", 
    status_code = 200L, headers = structure(list(date = "Thu, 13 Aug 2020 13:30:36 GMT", 
        ...
        server = "cloudflare", `cf-ray` = "5c22caa92aabca4b-YUL"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(date = "Thu, 13 Aug 2020 13:30:36 GMT", 
