structure(list(
  ...
  status_code = 200L, headers = structure(list(
    date = "Fri, 09 Oct 2020 04:16:51 GMT",
    `content-type` = "application/json; charset=utf-8", vary = "Accept-Encoding",
    `cache-control` = "max-age=0, private, must-revalidate",
    `x-request-id` = "5fb0051dd3a7863ef91a34c35a05ff30",
    ...
    `cf-request-id` = "05ad2c80ab0000ca5799be3200000001",
    `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"",
    server = "cloudflare", `cf-ray` = "5df549e11be5ca57-YUL"
  ), class = c(
    "insensitive",
    "list"
    ...
    flag = TRUE, path = "/", secure = TRUE, expiration = structure(1604808967, class = c(
      "POSIXct",
      "POSIXt"
  ...
  date = structure(1602217011, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 3.8e-05,
    connect = 4.1e-05, pretransfer = 0.000137, starttransfer = 0.351364,
    total = 0.351464
  )
), class = "response")
