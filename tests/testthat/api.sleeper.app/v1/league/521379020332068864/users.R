structure(list(
  ...
  status_code = 200L, headers = structure(list(
    date = "Tue, 13 Oct 2020 01:45:19 GMT",
    `content-type` = "application/json; charset=utf-8", vary = "Accept-Encoding",
    `cache-control` = "max-age=0, private, must-revalidate",
    `x-request-id` = "b8c9fca5d8929b726ee16c232b8a7e16",
    ...
    `cf-request-id` = "05c13b32a10000ca6f41bd4200000001",
    `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"",
    server = "cloudflare", `cf-ray` = "5e1561643d68ca6f-YUL"
  ), class = c(
    "insensitive",
    "list"
  ...
  date = structure(1602553519, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 4.4e-05,
    connect = 4.7e-05, pretransfer = 0.000133, starttransfer = 0.321503,
    total = 0.321609
  )
), class = "response")
