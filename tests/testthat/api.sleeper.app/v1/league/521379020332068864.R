structure(list(url = "https://api.sleeper.app/v1/league/521379020332068864/", 
    status_code = 200L, headers = structure(list(date = "Tue, 13 Oct 2020 01:45:17 GMT", 
        ...
        server = "cloudflare", `cf-ray` = "5e156157fe62ca6f-YUL"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/2", 
        headers = structure(list(date = "Tue, 13 Oct 2020 01:45:17 GMT", 
