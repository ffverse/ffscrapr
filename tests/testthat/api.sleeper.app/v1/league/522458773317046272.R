structure(list(
  ...
  status_code = 200L, headers = structure(list(
    date = "Sun, 15 Nov 2020 18:45:05 GMT",
    `content-type` = "application/json; charset=utf-8", vary = "Accept-Encoding",
    `cache-control` = "max-age=0, private, must-revalidate",
    `x-request-id` = "bb5ae0a9b7379e20741992c8b638302d",
    ...
    `cf-request-id` = "066ed2b0d80000ca57ff02f000000001",
    `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"",
    server = "cloudflare", `cf-ray` = "5f2b20948d6cca57-YUL"
  ), class = c(
    "insensitive",
    "list"
  ...
  date = structure(1605465905, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 4e-05,
    connect = 4.6e-05, pretransfer = 0.000158, starttransfer = 0.324323,
    total = 0.324427
  )
), class = "response")
