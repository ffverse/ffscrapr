structure(list(url = "https://api.sleeper.app/v1/league/386236959468675072/", 
    status_code = 200L, headers = structure(list(date = "Sun, 15 Nov 2020 01:35:13 GMT", 
        ...
        server = "cloudflare", `cf-ray` = "5f253bfabb0cf039-EWR"), class = c("insensitive", 
    "list")), all_headers = list(list(status = 200L, version = "HTTP/1.1", 
        headers = structure(list(date = "Sun, 15 Nov 2020 01:35:13 GMT", 
    ...
    date = structure(1605404113, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0, namelookup = 0.000101, 
    connect = 0.000105, pretransfer = 0.000305, starttransfer = 0.326536, 
    total = 0.326661)), class = "response")
