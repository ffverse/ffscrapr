structure(list(
  ...
  status_code = 200L, headers = structure(list(
    ...
    `cf-request-id` = "066b23d0b30000f0394a0b8000000001",
    `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"",
    server = "cloudflare", `cf-ray` = "5f253bfabb0cf039-EWR"
  ), class = c(
    "insensitive",
    "list"
    ...
    flag = TRUE, path = "/", secure = TRUE, expiration = structure(1607995646, class = c(
      "POSIXct",
      "POSIXt"
  ...
  date = structure(1605404113, class = c("POSIXct", "POSIXt"), tzone = "GMT"), times = c(
    redirect = 0, namelookup = 0.000101,
    connect = 0.000105, pretransfer = 0.000305, starttransfer = 0.326536,
    total = 0.326661
  )
), class = "response")
